    ...
    <>
      ...
      <section id="Header" className="flex justify-between items-center h-auto md:h-24 w-full border border-gray-300 px-4">
        <div className="max-w-7xl w-full flex justify-between items-center mx-auto py-4 md:py-0">
          ...
          <Link href="/" className="text-lg hover:underline hover:underline-offset-4 hover:font-bold">Home</Link>
            ...
            <button className="relative">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M21.438 5.432c-1.92-1.92-5.045-1.92-6.964 0l-.474.475-.474-.475c-1.92-1.92-5.045-1.92-6.964 0a4.923 4.923 0 0 0 0 6.964l7.438 7.438 7.438-7.438a4.923 4.923 0 0 0 0-6.964z"
                />
              </svg>
            </button>
            <button className="relative">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M3.5 3h2.3l1.9 8.8c.1.6.6 1 1.2 1h9.5c.6 0 1.1-.4 1.2-1l1.3-7.5H6.3"
                />
