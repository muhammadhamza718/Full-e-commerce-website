      ...
      <div className="max-w-7xl w-full flex justify-between items-center mx-auto">
        ...
        <div className="flex items-center gap-6">
          ...
          <button>
            ...
            <span className="absolute top-[76px] right-[388px] bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">4</span>
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              <div className=" absolute right-0 backdrop-blur-lg bg-black/40 shadow-md rounded-md w-56">
                <ul className="p-2">
